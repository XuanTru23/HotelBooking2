...
public class RCVWishlistManagerAdapter extends RecyclerView.Adapter<RCVWishlistManagerAdapter.HotelViewHolder>{

    ArrayList<Hotel> list;
    public RCVWishlistManagerAdapter(ArrayList<Hotel> list) {
        this.list = list;
    }
    ...
    public HotelViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_rcv_wishlist, parent,false);
        ...
        holder.img_btn_save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (hotel.isSaved()) {
                    ...
                    reference.child(idHotel).child("isSaved").child(idUser).removeValue();
    ...
    public class HotelViewHolder extends RecyclerView.ViewHolder {
        ...
        private AppCompatImageButton img_btn_save;
