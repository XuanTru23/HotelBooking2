...
public class RCVTopHotel2ManagerAdapter extends RecyclerView.Adapter<RCVTopHotel2ManagerAdapter.HotelViewHolder>{

    ArrayList<Hotel> list;
    public RCVTopHotel2ManagerAdapter(ArrayList<Hotel> list) {
        this.list = list;
    }
    ...
    public HotelViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_rcv_top_hotels_2, parent,false);
